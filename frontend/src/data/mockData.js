...
export const mockUsers = [
    {
        ...
        education: [{ institution: "MIT · Computer Science", years: "2022 - 2026" }],
        experience: [
            { company: "CampusConnect Labs", role: "Frontend Engineer Intern" },
            { company: "Open Source Guild", role: "Contributor" },
        ],
        projects: [
            { title: "Nyaya-Setu", techStack: ["React", "Node.js", "MongoDB"] },
            { title: "ResolveIt", techStack: ["Prisma", "PostgreSQL", "Vite"] },
        ],
        github: "alexchen",
    ...
    },
    {
        ...
        education: [{ institution: "Stanford · Data Science", years: "2021 - 2025" }],
        experience: [
            { company: "Insight Hub", role: "ML Research Intern" },
            { company: "Campus Data Club", role: "Mentor" },
        ],
        projects: [
            { title: "CampusPulse", techStack: ["Python", "Pandas", "Streamlit"] },
            { title: "Data4Good", techStack: ["TensorFlow", "FastAPI"] },
        ],
        github: "priyasharma",
    ...
    },
    {
        ...
        education: [{ institution: "UC Berkeley · Mechanical Engineering", years: "2022 - 2026" }],
        experience: [{ company: "RoboSphere", role: "Systems Intern" }],
        projects: [{ title: "AutoNav Rover", techStack: ["ROS", "C++", "Python"] }],
        github: "jameswilson",
        linkedin: "james-wilson-berkeley",
        portfolio: "https://jameswilson.build",
        karma: 654,
    ...
    },
    {
        ...
        education: [{ institution: "NYU · Digital Media", years: "2021 - 2025" }],
        experience: [{ company: "DesignVerse", role: "Product Designer Intern" }],
        projects: [{ title: "FlowBoard", techStack: ["Figma", "React", "Tailwind"] }],
        github: "sarahmartinez",
        linkedin: "sarah-martinez-nyu",
    ...
    },
    {
        ...
        education: [{ institution: "CMU · Computer Science", years: "2020 - 2024" }],
        experience: [{ company: "CloudCore", role: "Backend Engineer Intern" }],
        projects: [{ title: "ThreadScale", techStack: ["Java", "Redis", "Kafka"] }],
        github: "rajpatel",
