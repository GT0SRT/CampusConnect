    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          >
            <Clock className="w-4 h-4" style={{ color: "#00eaff" }} />
      ...
      <div className="border-t border-border bg-card/80 backdrop-blur-sm sticky bottom-0">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <ChevronLeft className="w-4 h-4" style={{ color: "#00eaff" }} /> Previous
          </button>
          ...
          <div className="hidden sm:flex items-center gap-1.5">
            {questions.map((_, i) => (
              ...
              >
                {answers[questions[i].id] ? <CheckCircle2 className="w-4 h-4" style={{ color: "#00eaff" }} /> : i + 1}
              </button>
            ))}
          </div>
          ...
          {current < questions.length - 1 ? (
            ...
            >
              Next <ChevronRight className="w-4 h-4" style={{ color: "#00eaff" }}/>
            </button>
          ) : (
            <button
            ...
            >
              {loading ? (
                ...
                <>
                  Submit <Send className="w-4 h-4" style={{ color: "#00eaff" }} />
                </>
              )}
            </button>
          )}
